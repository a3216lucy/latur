...
var goBtn = document.getElementById('go'); //利用goBtn可以獲取go的去程資料
var backBtn = document.getElementById('back');//利用backBtn可以獲取back的回程資料
var busList = document.getElementById('bus-way-list');// busList用來放公車列表清單

goBtn.addEventListener('click', getGoJson, false);//設置監聽功能，點擊時觸發,獲取GoJson
backBtn.addEventListener('click', getBackJson, false);//設置監聽功能，點擊時觸發,獲取BackJson
